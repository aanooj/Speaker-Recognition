...
var CallsController = {
     ...
     */
    retrieveACall : function(callID, orgID, callback){
     ...
     */
    createANewCallRecordAndTriggerRecognitionAlgorithmExecution : function(body, callID, orgID, callback){
     ...
     */
    updateAnExistingCallRecordAndTriggerRecognitionAlgorithmExecution : function(body, callID, orgID, callback){
     ...
     * @return {void}
     */
    deleteACall : function(callID, orgID, callback){
